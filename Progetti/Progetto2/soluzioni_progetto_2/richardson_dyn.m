function [x,err,k] = richardson_dyn(A,b,x0,P,toll,nitmax,stop_test)
%
% Authors: Riccardo Sacco
%
% This script implements the dynamic Richardson method
%
...
%
% [x,err,k] = richardson_dyn(A,b,x0,P,toll,nitmax,stop_test)
%
n      = max(size(b)); 
% initial guess
x      = x0;   
% initial residual
r      = b - A*x;
% initializationdiag(diag(A),-1) for the termination test
r0     = r;
xold   = x;
%
k      = 0 ;
